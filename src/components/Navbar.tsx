    ...
    <nav className="fixed top-0 w-full z-50 bg-white/80 backdrop-blur-md border-b border-gray-200 text-gray-900">
      ...
      >
        ...
        >
          <a
            href="/portfolio"
            className="relative opacity-70 hover:opacity-100 transition duration-300 after:absolute after:left-0 after:-bottom-1 after:h-[1px] after:w-full after:bg-black after:origin-left after:scale-x-0 after:transition-transform after:duration-300 hover:after:scale-x-100"
          >
            Portfolio
          </a>
